...
public class ProfileController {
    ...
    public ResponseEntity<ApiResponse> getUserProfile(@PathVariable Long id) {
        ...
        if (userOpt.isPresent()) {
            return ResponseEntity.ok(
                    new ApiResponse(true, userOpt.get(), "Profile retrieved successfully!"));
        }
    ...
    public ResponseEntity<ApiResponse> updateProfile(
        ...
        if (userOpt.isPresent()) {
            ...
            return ResponseEntity.ok(
                    new ApiResponse(true, existingUser, "Profile updated successfully!"));
        }
    ...
    public ResponseEntity<ApiResponse> checkEligibility(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(new ApiResponse(true,
                Map.of(
                        ...
                        "message",           isEligible ? "Ready to Donate" :
